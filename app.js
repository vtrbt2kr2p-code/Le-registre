...
const ICONS = {
  ...
  info:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="9"/><path d="M12 11v6M12 8h0"/></svg>`,
  upload:`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 3v12M7 8l5-5 5 5"/><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"/></svg>`,
  book:`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>`,
};
...
const FONT_OPTIONS = [
  ...
  {id:'sourcesans', label:'Source Sans 3', css:"'Source Sans 3', sans-serif"},
  {id:'raleway', label:'Raleway', css:"'Raleway', sans-serif"},
  {id:'worksans', label:'Work Sans', css:"'Work Sans', sans-serif"},
  {id:'rubik', label:'Rubik', css:"'Rubik', sans-serif"},
  {id:'mulish', label:'Mulish', css:"'Mulish', sans-serif"},
  {id:'ptsans', label:'PT Sans', css:"'PT Sans', sans-serif"},
  {id:'karla', label:'Karla', css:"'Karla', sans-serif"},
  ...
  {id:'spacegrotesk', label:'Space Grotesk', css:"'Space Grotesk', sans-serif"},
];
function fontCssFor(id){
...
const TRANSLATIONS = {
  fr: {
    ...
    fieldFontFamily: 'Police de caractères',
    ...
    fieldLogo: "Logo de l'entreprise", logoUploadBtn: 'Choisir un fichier', logoRemoveBtn: 'Supprimer le logo',
    fieldLogoShape: 'Forme du logo', logoShapeRound: 'Rond (tampon)', logoShapeSquare: 'Carré arrondi',
    ...
    colQty: 'Qté', colUnit: 'Unité', colDiscount: 'Remise %',
    colUnitPriceHTshort: 'Prix HT', colVatPct: 'TVA %', colTotalHTshort: 'Total HT',
    descriptionPlaceholder: 'Description', removeLineTitle: 'Supprimer la ligne',
    addLineBtn: 'Ajouter une ligne', billedTo: 'Facturé à',
    totalHTLabel: 'Total HT', totalTTCLabel: 'Total TTC', totalRemiseLabel: 'Remises accordées',
    sectionExtra: 'Informations complémentaires',
    fieldValidity: "Validité de l'offre / délai", placeholderValidity: 'Ex. 30 jours',
    fieldNotes: 'Notes / conditions particulières', placeholderNotes: 'Ex. Acompte de 30 % à la commande, matériel non compris…',
    sectionSignature: 'Signature', signatureHint: 'Signez au doigt ou à la souris', clearSignatureBtn: 'Effacer',
    pdfSideNote: "Le PDF exporté reprendra automatiquement ces informations, l'en-tête de votre entreprise (page « Mon entreprise »), votre logo, le tampon de statut et la signature.",
    ...
    defaultValidity: '30 jours', unitDefault: 'u.',
    ...
    toastLogoSaved: 'Logo enregistré', toastLogoRemoved: 'Logo supprimé',
    toastLogoError: "Impossible de lire ce fichier. Essayez une image JPG ou PNG.",
    toastSignatureCleared: 'Signature effacée', toastGuideExported: "Guide PDF téléchargé",
    ...
    pdfIban: 'IBAN', pdfYourCompany: 'Votre entreprise', pdfValidity: "Validité de l'offre",
    pdfNotes: 'Notes', pdfSignatureLabel: 'Signature',
    ...
    aboutTagline: 'Informations sur l\'application',
    aboutWhatTitle: "Qu'est-ce que Le Registre ?",
    aboutWhatBody: "Le Registre est une application de gestion de devis et factures, pensée pour les artisans, indépendants et petites entreprises. Elle fonctionne entièrement dans votre navigateur, sans connexion permanente à internet, et permet de créer des documents détaillés (lignes, unités, remises, TVA), d'y ajouter votre logo et votre signature, puis de les exporter en PDF prêts à envoyer.",
    aboutDesignerTitle: 'Conception',
    aboutDesignerBody: "Application conçue par Mike Pelé.",
    aboutVersion: 'Version 2.0',
    aboutPrivacyTitle: 'Confidentialité des données',
    aboutPrivacyBody: "Toutes vos données (clients, articles, devis, factures, logo, signature) sont enregistrées uniquement dans le stockage privé de votre navigateur, sur cet appareil. Rien n'est envoyé ni stocké sur un serveur. En contrepartie, ces données ne sont pas partagées automatiquement entre plusieurs appareils : pensez à exporter régulièrement vos documents importants en PDF, et à ne pas vider les données de navigation de votre navigateur sans avoir sauvegardé ce qui compte.",
    aboutTermsTitle: "Conditions d'utilisation",
    aboutTermsBody: "L'application est fournie « en l'état », gratuitement et sans garantie d'aucune sorte.\n\nL'utilisateur reste seul responsable de l'exactitude et de la conformité légale des devis et factures qu'il génère (mentions obligatoires, taux de TVA applicables, numéro SIRET, etc.), ainsi que de leurs obligations comptables et fiscales.\n\nL'application ne collecte, ne transmet ni ne vend aucune donnée personnelle : tout reste stocké localement sur l'appareil de l'utilisateur.\n\nL'éditeur ne pourra être tenu responsable d'une perte de données liée à la suppression du cache du navigateur, à un changement d'appareil, ou à un dysfonctionnement du navigateur utilisé.\n\nEn utilisant cette application, l'utilisateur accepte ces conditions.",
    ...
    onboardStep2Title: '2. Créez un devis', onboardStep2Body: "Bouton « Nouveau devis », choisissez un client, ajoutez vos lignes de prestation : les totaux HT/TVA/TTC se calculent tout seuls.",
    ...
    onboardStep4Title: '4. Exportez en PDF', onboardStep4Body: "Depuis chaque devis ou facture, exportez un PDF prêt à envoyer, avec votre logo et vos coordonnées d'entreprise.",
  ...
  en: {
    ...
    fieldLogo: 'Company logo', logoUploadBtn: 'Choose a file', logoRemoveBtn: 'Remove logo',
    fieldLogoShape: 'Logo shape', logoShapeRound: 'Round (seal)', logoShapeSquare: 'Rounded square',
    ...
    colQty: 'Qty', colUnit: 'Unit', colDiscount: 'Discount %',
    colUnitPriceHTshort: 'Unit price', colVatPct: 'VAT %', colTotalHTshort: 'Total excl. VAT',
    descriptionPlaceholder: 'Description', removeLineTitle: 'Remove line',
    addLineBtn: 'Add a line', billedTo: 'Billed to',
    totalHTLabel: 'Subtotal (excl. VAT)', totalTTCLabel: 'Total (incl. VAT)', totalRemiseLabel: 'Discounts applied',
    sectionExtra: 'Additional information',
    fieldValidity: 'Quote validity / lead time', placeholderValidity: 'e.g. 30 days',
    fieldNotes: 'Notes / special terms', placeholderNotes: 'e.g. 30% deposit on order, materials not included…',
    sectionSignature: 'Signature', signatureHint: 'Sign with your finger or mouse', clearSignatureBtn: 'Clear',
    pdfSideNote: 'The exported PDF will automatically include this information, your company header (from the "My business" page), your logo, the status stamp and the signature.',
    ...
    defaultValidity: '30 days', unitDefault: 'unit',
    ...
    toastLogoSaved: 'Logo saved', toastLogoRemoved: 'Logo removed',
    toastLogoError: 'Could not read this file. Try a JPG or PNG image.',
    toastSignatureCleared: 'Signature cleared', toastGuideExported: 'PDF guide downloaded',
    ...
    pdfIban: 'IBAN', pdfYourCompany: 'Your business', pdfValidity: 'Quote validity',
    pdfNotes: 'Notes', pdfSignatureLabel: 'Signature',
    ...
    aboutTagline: 'Application information',
    aboutWhatTitle: 'What is The Registry?',
    aboutWhatBody: "The Registry is a quote and invoice management app, designed for tradespeople, freelancers and small businesses. It runs entirely in your browser, without a permanent internet connection, and lets you create detailed documents (line items, units, discounts, VAT), add your logo and signature, then export them as ready-to-send PDFs.",
    aboutDesignerTitle: 'Design',
    aboutDesignerBody: 'Application designed by Mike Pelé.',
    aboutVersion: 'Version 2.0',
    aboutPrivacyTitle: 'Data privacy',
    aboutPrivacyBody: "All your data (clients, items, quotes, invoices, logo, signature) is saved only in your browser's private storage, on this device. Nothing is sent to or stored on a server. As a result, this data is not automatically shared across multiple devices: remember to regularly export your important documents to PDF, and avoid clearing your browser data without backing up what matters.",
    aboutTermsTitle: 'Terms of use',
    aboutTermsBody: "This application is provided \"as is\", free of charge, without any warranty.\n\nThe user remains solely responsible for the accuracy and legal compliance of the quotes and invoices they generate (mandatory disclosures, applicable VAT rates, business registration number, etc.), as well as their accounting and tax obligations.\n\nThe application does not collect, transmit or sell any personal data: everything stays stored locally on the user's device.\n\nThe publisher cannot be held responsible for data loss related to clearing browser cache, changing devices, or a malfunction of the browser used.\n\nBy using this application, the user accepts these terms.",
    ...
    onboardStep2Title: '2. Create a quote', onboardStep2Body: 'Tap "New quote", pick a client, add your line items: subtotal, VAT and total are calculated automatically.',
    ...
    onboardStep4Title: '4. Export to PDF', onboardStep4Body: 'From any quote or invoice, export a ready-to-send PDF with your logo and company details.',
...
const state = {
  ...
  articles: [],
  documents: [],
  entreprise: { nom:'', adresse:'', siret:'', tva:'', iban:'', pied:'', logo:null, logoShape:'rond' },
  lang: 'fr',
  theme: 'clair',
  fontSize: 'moyen',
  fontFamily: 'inter',
...
function applyTheme(){
  ...
  document.documentElement.style.setProperty('--font-body', fontCssFor(state.fontFamily));
}
...
async function loadAll(){
  ...
  try{
    ...
    if(p){
      ...
      state.fontFamily = FONT_OPTIONS.some(f=>f.id===prefs.fontFamily) ? prefs.fontFamily : 'inter';
    }
...
function blankDoc(type){
  return {
    ...
    validite: type==='devis' ? t('defaultValidity') : '',
    notes: '',
    signature: null,
    lieDevisNumero: null,
    createdAt: Date.now(),
...
function blankLigne(){ return { id: uid(), description:'', unite: t('unitDefault'), quantite:1, prixUnitaireHT:0, remise:0, tauxTva:20 }; }
...
function computeTotals(doc){
  let totalHT = 0; let totalRemise = 0; const tvaByRate = {};
  for(const l of doc.lignes){
    ...
    const brut = qty * pu;
    const remiseMontant = brut * remisePct/100;
    const lineHT = brut - remiseMontant;
    totalHT += lineHT;
  ...
  return { totalHT, totalRemise, tvaByRate, totalTVA, totalTTC: totalHT + totalTVA };
}
...
async function setEntrepriseLogo(dataUrl){
  state.entreprise = Object.assign({}, state.entreprise, { logo: dataUrl });
  await refreshLogoMasked();
  await save('entreprise');
}
async function setLogoShape(shape){
  state.entreprise = Object.assign({}, state.entreprise, { logoShape: shape });
  await refreshLogoMasked();
  await save('entreprise');
}
// Pré-calcule la version "masquée" (ronde ou carrée arrondie) du logo, une fois
// pour toutes au moment de l'upload — jamais au moment de l'export PDF. Ainsi
// exportDocPdf() reste entièrement synchrone, ce qui est indispensable pour que
// le téléchargement fonctionne de façon fiable sur mobile (Safari iOS et
// certains navigateurs Android bloquent les téléchargements déclenchés après
// une attente asynchrone dans le gestionnaire de clic).
async function refreshLogoMasked(){
  if(state.entreprise.logo){
    try{
      state.entreprise.logoMasked = await maskImageDataURL(state.entreprise.logo, state.entreprise.logoShape||'rond', 240);
    }catch(err){
      console.warn('logo mask error', err);
      state.entreprise.logoMasked = null;
    }
  } else {
    state.entreprise.logoMasked = null;
  }
...
/* ============================= LOGO : lecture, redimension, masque ============================= */
...
async function fileToProcessedLogo(file){
  if(!file.type || !file.type.startsWith('image/')){
    throw new Error('unsupported-file-type');
  }
  const dataUrl = await readFileAsDataURL(file);
  return resizeImageDataURL(dataUrl, 480);
}
function maskImageDataURL(dataUrl, shape, size){
  return new Promise((resolve, reject)=>{
    const img = new Image();
    img.onload = ()=>{
      const canvas = document.createElement('canvas');
      ...
      ctx.beginPath();
      if(shape === 'carre'){
        const r = size*0.16, x=0, y=0, w=size, h=size;
    ...
    img.onerror = ()=> reject(new Error('mask failed'));
    img.src = dataUrl;
  });
}

/* ============================= COMPTE & SYNCHRONISATION CLOUD =============================
   Actif uniquement si FIREBASE_CONFIG a été renseigné (voir en haut du fichier).
   Le stockage local (window.storage) reste la source rapide utilisée à chaque
   instant ; la synchronisation cloud se fait en arrière-plan, sans jamais
   bloquer la sauvegarde locale — pour que l'application continue de
   fonctionner hors-ligne même avec un compte connecté. */
async function cloudPushValue(key, value){
  if(!FIREBASE_ENABLED || !state.user || !window.firebaseDb) return;
  try{
    await window.firebaseDb.collection('users').doc(state.user.uid).collection('store').doc(key).set({ value, updatedAt: Date.now() });
  }catch(err){ console.warn('cloud push error', key, err); }
}
async function cloudPullAll(){
  if(!FIREBASE_ENABLED || !state.user || !window.firebaseDb) return;
  const keys = ['clients','articles','documents','entreprise','preferences'];
  const remote = {};
  try{
    const snap = await window.firebaseDb.collection('users').doc(state.user.uid).collection('store').get();
    snap.forEach(d=>{ const data = d.data(); if(data && data.value !== undefined) remote[d.id] = data.value; });
  }catch(err){ console.warn('cloud pull error', err); return; }

  const hasRemoteData = keys.some(k => remote[k] !== undefined);
  if(hasRemoteData){
    // Le compte a déjà des données dans le cloud : elles font foi (utile en
    // se reconnectant depuis un nouvel appareil).
    if(remote.clients !== undefined) state.clients = remote.clients;
    if(remote.articles !== undefined) state.articles = remote.articles;
    if(remote.documents !== undefined) state.documents = remote.documents;
    if(remote.entreprise !== undefined){
      state.entreprise = Object.assign({ nom:'', adresse:'', siret:'', tva:'', iban:'', pied:'', logo:null, logoShape:'rond' }, remote.entreprise);
    }
    if(remote.preferences !== undefined){
      const p = remote.preferences;
      state.lang = p.lang==='en' ? 'en' : 'fr';
      state.theme = p.theme==='sombre' ? 'sombre' : 'clair';
      state.fontSize = ['petit','moyen','grand'].includes(p.fontSize) ? p.fontSize : 'moyen';
      state.fontFamily = FONT_OPTIONS.some(f=>f.id===p.fontFamily) ? p.fontFamily : 'inter';
    }
    try{
      await Promise.all([
...
function translateAuthError(err){
  ...
  const map = {
    'auth/email-already-in-use': isEn ? 'This email is already registered.' : 'Cette adresse e-mail est déjà utilisée.',
    'auth/invalid-email': isEn ? 'Invalid email address.' : 'Adresse e-mail invalide.',
    'auth/weak-password': isEn ? 'Password must be at least 6 characters.' : 'Le mot de passe doit contenir au moins 6 caractères.',
    'auth/user-not-found': isEn ? 'No account found for this email.' : 'Aucun compte trouvé pour cet e-mail.',
...
function renderAuth(){
  ...
  return `
  <div style="display:flex;align-items:center;justify-content:center;min-height:100vh;padding:24px;background:var(--ink);">
    <div class="card" style="max-width:380px;width:100%;padding:28px;">
      <div style="text-align:center;margin-bottom:18px;">
        <div style="font-family:'Fraunces',serif;font-style:italic;font-size:1.5rem;color:var(--ink);">${t('appName')}</div>
        <div style="font-size:0.75rem;color:var(--ink-faint);margin-top:4px;">${isSignup ? t('authSignupSubtitle') : t('authLoginSubtitle')}</div>
      </div>
      ...
      <div style="text-align:center;margin-top:14px;font-size:0.8125rem;color:var(--ink-soft);">
        ...
        <button type="button" class="btn ghost" data-action="toggle-auth-mode" style="padding:2px 4px;">${isSignup ? t('authLoginBtn') : t('authSignupBtn')}</button>
      </div>
      <div class="hint" style="margin-top:14px;text-align:center;">${t('authPrivacyHint')}</div>
    </div>
  </div>`;
}
function bindAuthEvents(){
  const app = document.getElementById('app');
  const form = app.querySelector('#form-auth');
  if(form) form.onsubmit = async (e)=>{
    ...
    try{
      if(state.authMode === 'signup'){
        ...
        await window.firebaseAuth.createUserWithEmailAndPassword(fd.email, fd.password);
      } else {
        await window.firebaseAuth.signInWithEmailAndPassword(fd.email, fd.password);
      }
    }catch(err){
  ...
  const toggleBtn = app.querySelector('[data-action="toggle-auth-mode"]');
...
function render(){
  ...
  try{
    applyTheme();
    if(FIREBASE_ENABLED && !state.authChecked){
      app.innerHTML = `<div style="height:100vh;width:100%;background:var(--ink);"></div>`;
      return;
    }
...
function renderSidebar(){
  ...
  <div class="sidebar ${state.sidebarOpen?'open':''}">
    ...
    <div class="sidebar-foot">
      ...
      <button data-action="guide-pdf">${ICONS.book} ${t('guideBtn')}</button>
      ${FIREBASE_ENABLED && state.user ? `
        <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,0.12);font-size:0.6875rem;color:#9FB0C9;word-break:break-all;">
          ${escapeHtml(state.user.email||'')}
        </div>
        <button data-action="sign-out">${t('authLogoutBtn')}</button>
      ` : ''}
    </div>
  </div>`;
}
...
function renderParametres(){
  ...
  return `
    ...
    <div class="card" style="padding:24px;max-width:560px;margin-bottom:16px;">
      <div class="section-title" style="border:none;padding:0;margin-bottom:14px;">${t('fieldLogo')}</div>
      <div style="display:flex;gap:16px;align-items:center;flex-wrap:wrap;">
        <div class="logo-preview-wrap ${e.logoShape==='carre'?'carre':''}">
          ${e.logo ? `<img src="${e.logo}" alt="">` : `<span class="placeholder">${t('logoPlaceholder')}</span>`}
        </div>
        <div style="display:flex;flex-direction:column;gap:8px;">
          <input type="file" id="logo-input" accept="image/*" hidden>
          <button type="button" class="btn secondary" id="logo-upload-btn">${ICONS.upload} ${t('logoUploadBtn')}</button>
          ${e.logo ? `<button type="button" class="btn danger" id="logo-remove-btn">${ICONS.trash} ${t('logoRemoveBtn')}</button>` : ''}
        </div>
      </div>
      <div class="field" style="margin-top:14px;max-width:260px;">
        <label>${t('fieldLogoShape')}</label>
        <select id="logo-shape-select">
          <option value="rond" ${e.logoShape!=='carre'?'selected':''}>${t('logoShapeRound')}</option>
          <option value="carre" ${e.logoShape==='carre'?'selected':''}>${t('logoShapeSquare')}</option>
        </select>
      </div>
...
function renderApropos(){
  return `
    <div class="page-head">
      <div><div class="eyebrow">${t('navAbout')}</div><h1>${t('appName')}</h1><p>${t('aboutTagline')}</p></div>
    </div>

    <div class="card" style="padding:24px;max-width:640px;margin-bottom:16px;">
      <div class="section-title" style="border:none;padding:0;margin-bottom:10px;">${t('aboutWhatTitle')}</div>
      <p style="font-size:0.8438rem;color:var(--ink-soft);line-height:1.6;margin:0;">${t('aboutWhatBody')}</p>
    </div>

    <div class="card" style="padding:24px;max-width:640px;margin-bottom:16px;">
      <div class="section-title" style="border:none;padding:0;margin-bottom:10px;">${t('aboutDesignerTitle')}</div>
      <p style="font-size:0.8438rem;color:var(--ink-soft);line-height:1.6;margin:0;">${t('aboutDesignerBody')}</p>
      <p style="font-size:0.75rem;color:var(--ink-faint);margin-top:8px;">${t('aboutVersion')}</p>
    </div>

    <div class="card" style="padding:24px;max-width:640px;margin-bottom:16px;">
      <div class="section-title" style="border:none;padding:0;margin-bottom:10px;">${t('aboutPrivacyTitle')}</div>
      <p style="font-size:0.8438rem;color:var(--ink-soft);line-height:1.6;margin:0;">${t('aboutPrivacyBody')}</p>
    </div>

    <div class="card" style="padding:24px;max-width:640px;">
      <div class="section-title" style="border:none;padding:0;margin-bottom:10px;">${t('aboutTermsTitle')}</div>
      <p style="font-size:0.8125rem;color:var(--ink-soft);line-height:1.7;white-space:pre-line;margin:0;">${t('aboutTermsBody')}</p>
    </div>
  `;
}
  ...
  return `
    ...
    <div class="card" style="padding:24px;max-width:560px;">
      ...
      <div class="field-row" style="margin-top:12px;">
        ...
        <div class="field">
          <label>${t('fieldFontFamily')}</label>
          <select id="pref-fontfamily">
            ${FONT_OPTIONS.map(f=>`<option value="${f.id}" ${state.fontFamily===f.id?'selected':''}>${f.label}</option>`).join('')}
          </select>
        </div>
      </div>
    </div>
...
function renderEditor(){
  ...
  const logo = state.entreprise.logo;
    ...
    <div class="doc-grid">
      <div class="card doc-main">
        ...
        <div>
          ...
          <table class="lines-table" style="margin-top:12px;">
            <thead><tr>
              <th style="width:26%">${t('colDescription')}</th>
              <th style="width:10%">${t('colUnit')}</th>
              <th style="width:9%">${t('colQty')}</th>
              <th style="width:14%">${t('colUnitPriceHTshort')}</th>
              <th style="width:11%">${t('colDiscount')}</th>
              <th style="width:9%">${t('colVatPct')}</th>
              <th style="width:14%">${t('colTotalHTshort')}</th>
              <th></th>
            </tr></thead>
            <tbody>
              ${doc.lignes.map((l)=>`
                <tr data-line="${l.id}">
                  ...
                  <td><input list="units-list" data-line-field="unite" data-line-id="${l.id}" value="${escapeHtml(l.unite||'')}"></td>
                  ...
                  <td><input type="number" min="0" max="100" step="1" data-line-field="remise" data-line-id="${l.id}" value="${l.remise||0}"></td>
                  <td><input type="number" min="0" step="0.1" data-line-field="tauxTva" data-line-id="${l.id}" value="${l.tauxTva}"></td>
                  <td class="num-col">${eur((parseFloat(l.quantite)||0)*(parseFloat(l.prixUnitaireHT)||0)*(1-(parseFloat(l.remise)||0)/100))}</td>
          ...
          <datalist id="units-list">
            <option value="u."><option value="h"><option value="jour"><option value="m²"><option value="m"><option value="kg"><option value="forfait">
          </datalist>
          <button class="btn secondary add-line" data-action="add-line">${ICONS.plus} ${t('addLineBtn')}</button>
        </div>

        <div>
          <div class="section-title">${t('sectionExtra')}</div>
          <div class="field-row" style="margin-top:12px;">
            <div class="field"><label>${t('fieldValidity')}</label><input id="f-validite" value="${escapeHtml(doc.validite||'')}" placeholder="${t('placeholderValidity')}"></div>
          </div>
          <div class="field" style="margin-top:12px;"><label>${t('fieldNotes')}</label><textarea id="f-notes" placeholder="${t('placeholderNotes')}">${escapeHtml(doc.notes||'')}</textarea></div>
        </div>
      ...
      <div class="doc-side">
        <div class="card doc-preview">
          ...
          ${logo ? `<div class="doc-logo ${state.entreprise.logoShape==='carre'?'carre':''}"><img src="${logo}" alt=""></div>` : ''}
          ...
          <div class="totals">
            ...
            ${totals.totalRemise > 0 ? `<div class="row"><span>${t('totalRemiseLabel')}</span><span class="num">- ${eur(totals.totalRemise)}</span></div>` : ''}
        ...
        <div class="card" style="padding:20px;">
          ...
          <div class="signature-actions">
            <span class="signature-hint">${t('signatureHint')}</span>
            <button type="button" class="btn ghost" data-action="clear-signature">${t('clearSignatureBtn')}</button>
          </div>
        </div>
...
function bindPostRender(){
  ...
  const guidePdfBtn = app.querySelector('[data-action="guide-pdf"]');
  if(guidePdfBtn) guidePdfBtn.onclick = generateGuidePdf;
  ...
  const logoUploadBtn = app.querySelector('#logo-upload-btn');
  if(logoUploadBtn && logoInput) logoUploadBtn.onclick = ()=> logoInput.click();
  if(logoInput) logoInput.onchange = async ()=>{
    const file = logoInput.files[0];
    if(!file) return;
    try{
      const dataUrl = await fileToProcessedLogo(file);
      await setEntrepriseLogo(dataUrl);
      toast(t('toastLogoSaved'));
      render();
    }catch(err){
  ...
  const logoRemoveBtn = app.querySelector('#logo-remove-btn');
  if(logoRemoveBtn) logoRemoveBtn.onclick = async ()=>{
    await setEntrepriseLogo(null);
    toast(t('toastLogoRemoved'));
    render();
  };
  const logoShapeSelect = app.querySelector('#logo-shape-select');
  if(logoShapeSelect) logoShapeSelect.onchange = async ()=>{
    await setLogoShape(logoShapeSelect.value);
    render();
  };
  ...
  const prefFontFamily = app.querySelector('#pref-fontfamily');
  if(prefFontFamily) prefFontFamily.onchange = ()=>{ state.fontFamily = prefFontFamily.value; savePreferences(); applyTheme(); };
...
function bindEditorEvents(app){
  ...
  if(validiteInp) validiteInp.onchange = ()=>{ doc.validite = validiteInp.value; scheduleAutosave(doc); };
  const notesInp = app.querySelector('#f-notes');
  if(notesInp) notesInp.onchange = ()=>{ doc.notes = notesInp.value; scheduleAutosave(doc); };
  ...
  app.querySelectorAll('[data-line-field]').forEach(inp=>{
    inp.oninput = ()=>{
      ...
      l[field] = (field==='description' || field==='unite') ? inp.value : (parseFloat(inp.value)||0);
  ...
  const saveDocBtn = app.querySelector('[data-action="save-doc"]');
  if(saveDocBtn) saveDocBtn.onclick = ()=> persistDoc(doc);
...
function initSignaturePad(app, doc){
  ...
  const clearBtn = app.querySelector('[data-action="clear-signature"]');
  if(clearBtn) clearBtn.onclick = ()=>{
    const rect = canvas.getBoundingClientRect();
    ctx.clearRect(0, 0, rect.width, rect.height);
    doc.signature = null;
    persistDoc(doc, {silent:true});
    toast(t('toastSignatureCleared'));
  };
}
...
function exportDocPdf(doc){
  ...
  // Logo (en haut à droite, déjà pré-calculé en rond/carré lors de l'upload —
  // aucune opération asynchrone ici, pour que pdf.save() reste synchrone.
  if(e.logoMasked){
    try{ pdf.addImage(e.logoMasked, 'PNG', 474, 18, 50, 50); }
  ...
  pdf.text(`${t('pdfDate')} : ${formatDate(doc.date)}`, 260, y-6, {align:'left'});
  pdf.text(`${t('pdfStatus')} : ${statusMap[doc.statut]}`, 260, y+10);
  if(doc.lieDevisNumero) pdf.text(`${t('pdfEstablishedFrom')} ${doc.lieDevisNumero}`, 260, y+26);
  ...
  const rows = doc.lignes.map(l => {
    ...
    const totalLigne = qty*pu*(1-remise/100);
    return [
      l.description || '—',
      l.unite || t('unitDefault'),
      String(qty),
      pu.toFixed(2)+' €',
      remise ? remise+'%' : '—',
  ...
  pdf.autoTable({
    ...
    head:[[t('pdfDescription'), t('colUnit'), t('pdfQty'), t('pdfUnitPriceHT'), t('colDiscount'), t('colVat'), t('pdfTotalHT')]],
    body: rows,
    styles:{font:'helvetica', fontSize:9, textColor:[27,42,74], cellPadding:6},
  ...
  if(totals.totalRemise > 0){
    pdf.text(t('totalRemiseLabel'), totalsX, ty); pdf.text('- '+totals.totalRemise.toFixed(2)+' €', 547, ty, {align:'right'});
    ty += 15;
  }
  ...
  if(doc.validite){ ty+=14; pdf.text(`${t('pdfValidity')} : ${doc.validite}`, marginX, ty); }
  ...
  if(doc.notes){
    ...
    pdf.text(t('pdfNotes')+' :', marginX, ty);
    ty += 13;
    pdf.setFont('helvetica','normal');
    const split = pdf.splitTextToSize(doc.notes, 500);
    pdf.text(split, marginX, ty);
    ty += split.length*12;
  }
  ...
  if(doc.signature){
    if(ty > 660){ pdf.addPage(); ty = 60; }
    ty += 22;
    pdf.setFont('helvetica','bold'); pdf.setFontSize(9.5); pdf.setTextColor(90,90,90);
    pdf.text(t('pdfSignatureLabel')+' :', marginX, ty);
    try{
      pdf.addImage(doc.signature, 'PNG', marginX, ty+8, 140, 55);
...
function generateGuidePdf(){
  ...
  pdf.setFont('helvetica','bold'); pdf.setFontSize(20); pdf.setTextColor(27,42,74);
  pdf.text(isEn ? 'User Guide — The Registry' : "Guide d'utilisation — Le Registre", marginX, y);
  y += 30;
  pdf.setDrawColor(216,210,194); pdf.line(marginX, y, 547, y); y += 24;

  const sections = isEn ? [
    ['1. Getting started', "Everything you create stays on this device only, inside your browser's private storage. Nothing is ever sent to a server, even without an internet connection."],
    ['2. Set up your business', 'Go to "My business" to fill in your name, address, tax numbers and IBAN, and to upload your company logo. This information appears automatically on every PDF you export.'],
    ['3. Add clients and items', 'Use "Clients" and "Products & services" to save recurring contacts and services. They will be suggested automatically when creating a new quote.'],
    ['4. Create a detailed quote', 'Tap "New quote". Add one line per item: description, unit, quantity, unit price, discount % and VAT rate. Subtotals and totals are calculated automatically, line by line and overall — just like an Excel spreadsheet.'],
    ['5. Add a handwritten signature', 'On the quote or invoice screen, sign directly with your finger or mouse in the signature box on the right. Use "Clear" to redo it. The signature is included automatically in the exported PDF.'],
    ['6. Convert to an invoice', 'Once a quote is accepted, use "Convert to invoice" — a new invoice is created automatically with the same lines and client.'],
    ['7. Export to PDF', 'From any document, tap "Export to PDF" to generate a ready-to-send file including your logo, the detailed lines, totals, notes and signature.'],
    ['8. Track payments', 'Update the status of each document (Draft / Sent / Accepted / Paid) from its edit screen. The dashboard shows totals collected and pending.'],
  ] : [
    ['1. Pour commencer', "Tout ce que vous créez reste uniquement sur cet appareil, dans le stockage privé de votre navigateur. Rien n'est jamais envoyé à un serveur, même sans connexion internet."],
    ['2. Renseignez votre entreprise', "Rendez-vous dans « Mon entreprise » pour indiquer votre nom, adresse, SIRET, TVA, IBAN, et téléverser votre logo (image ou PDF). Ces informations apparaissent automatiquement sur chaque PDF exporté."],
    ['3. Ajoutez clients et articles', "Utilisez « Clients » et « Articles & services » pour enregistrer vos contacts et prestations récurrentes. Ils seront proposés automatiquement lors de la création d'un devis."],
    ['4. Créez un devis détaillé', "Appuyez sur « Nouveau devis ». Ajoutez une ligne par prestation : description, unité, quantité, prix unitaire, remise % et taux de TVA. Les totaux se calculent automatiquement, ligne par ligne et au global — comme sur un tableau Excel."],
    ['5. Ajoutez une signature manuscrite', "Sur l'écran du devis ou de la facture, signez directement au doigt ou à la souris dans le cadre prévu à droite. Le bouton « Effacer » permet de recommencer. La signature est intégrée automatiquement au PDF exporté."],
    ['6. Convertissez en facture', "Une fois le devis accepté, utilisez « Convertir en facture » : une nouvelle facture est créée automatiquement avec les mêmes lignes et le même client."],
    ['7. Exportez en PDF', "Depuis n'importe quel document, appuyez sur « Exporter en PDF » pour générer un fichier prêt à envoyer, avec votre logo, les lignes détaillées, les totaux, les notes et la signature."],
    ['8. Suivez vos paiements', "Mettez à jour le statut de chaque document (Brouillon / Envoyé / Accepté / Payée) depuis son écran d'édition. Le tableau de bord affiche les montants encaissés et en attente."],
  ];

  sections.forEach(([h,body])=>{
    if(y > 720){ pdf.addPage(); y = 60; }
    pdf.setFont('helvetica','bold'); pdf.setFontSize(12); pdf.setTextColor(179,58,46);
    pdf.text(h, marginX, y); y += 16;
    pdf.setFont('helvetica','normal'); pdf.setFontSize(10.5); pdf.setTextColor(60,60,60);
    const split = pdf.splitTextToSize(body, 500);
    pdf.text(split, marginX, y);
    y += split.length*14 + 16;
  });

  pdf.save(isEn ? 'registry-guide.pdf' : 'guide-le-registre.pdf');
  toast(t('toastGuideExported'));
}
...
function boot(){
  if(FIREBASE_ENABLED && window.firebase){
    render(); // écran neutre pendant la vérification de session
    try{
      ...
      window.firebaseAuth.onAuthStateChanged(async (user)=>{
        ...
        if(user){
          ...
          if(state.justSignedUp){
            state.justSignedUp = false;
            state.view = 'parametres';
            toast(t('toastWelcomeSetup'));
          }
          render();
        } else {
          state.loaded = false;
