    ...
    <div class="doc-grid">
      ...
      <div class="doc-side">
        <div class="card doc-preview">
          ...
          ${doc.signature ? `<div class="hint" style="margin-top:10px;">✓ ${t('signedOn')} ${formatDate(doc.signatureDate)}</div>` : ''}
        </div>
...
function generateGuidePdf(){
  ...
  pdf.save(isEn ? 'user-guide.pdf' : 'guide-utilisation.pdf');
  toast(t('toastGuideGenerated'));
}
